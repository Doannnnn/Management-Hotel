    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="room-item">
                    <img src="../hotel/img/room/room-1.jpg" alt="">
                    <div class="ri-text">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="room-item">
                    <img src="../hotel/img/room/room-2.jpg" alt="">
                    <div class="ri-text">
                        <h4>Deluxe Room</h4>
                        <h3>159$<span>/Pernight</span></h3>
                        <table>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="room-item">
                    <img src="../hotel/img/room/room-3.jpg" alt="">
                    <div class="ri-text">
                        <h4>Double Room</h4>
                        <h3>159$<span>/Pernight</span></h3>
                        <table>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="room-item">
                    <img src="../hotel/img/room/room-4.jpg" alt="">
                    <div class="ri-text">
                        <h4>Luxury Room</h4>
                        <h3>159$<span>/Pernight</span></h3>
                        <table>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="room-item">
                    <img src="../hotel/img/room/room-5.jpg" alt="">
                    <div class="ri-text">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="room-item">
                    <img src="../hotel/img/room/room-6.jpg" alt="">
                    <div class="ri-text">
                        <h4>Small View</h4>
                        <h3>159$<span>/Pernight</span></h3>
                        <table>
