...
<div class="offcanvas-menu-wrapper">
    ...
    <nav class="mainmenu mobile-menu">
        <ul>
            <li><a href="../guest/guest.jsp">Home</a></li>
            <li><a href="../guest/guestAbout-Us.jsp">About Us</a></li>
            <li class="active"><a href="../guest/guestBlog.jsp">News</a></li>
            <li><a href="../guest/guestContact.jsp">Contact</a></li>
        </ul>
    </nav>
...
<section class="blog-section blog-page spad">
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="blog-item set-bg" data-setbg="../hotel/img/blog/blog-1.jpg">
                    <div class="bi-text">
                        ...
                        <h4><a href="../guest/guestBlog-Detail.jsp">Tremblant In Canada</a></h4>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="blog-item set-bg" data-setbg="../hotel/img/blog/blog-2.jpg">
                    <div class="bi-text">
                        ...
                        <h4><a href="../guest/guestBlog-Detail.jsp">Choosing A Static Caravan</a></h4>
                        <div class="b-time"><i class="icon_clock_alt"></i> 15th April, 2019</div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="blog-item set-bg" data-setbg="../hotel/img/blog/blog-3.jpg">
                    <div class="bi-text">
                        ...
                        <h4><a href="../guest/guestBlog-Detail.jsp">Copper Canyon</a></h4>
                        <div class="b-time"><i class="icon_clock_alt"></i> 21th April, 2019</div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="blog-item set-bg" data-setbg="../hotel/img/blog/blog-4.jpg">
                    <div class="bi-text">
                        <span class="b-tag">Trivago</span>
                        <h4><a href="../guest/guestBlog-Detail.jsp">A Time Travel Postcard</a></h4>
                        <div class="b-time"><i class="icon_clock_alt"></i> 22th April, 2019</div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="blog-item set-bg" data-setbg="../hotel/img/blog/blog-5.jpg">
                    <div class="bi-text">
                        <span class="b-tag">Camping</span>
                        <h4><a href="../guest/guestBlog-Detail.jsp">A Time Travel Postcard</a></h4>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="blog-item set-bg" data-setbg="../hotel/img/blog/blog-6.jpg">
                    <div class="bi-text">
                        <span class="b-tag">Travel Trip</span>
                        <h4><a href="../guest/guestBlog-Detail.jsp">Virginia Travel For Kids</a></h4>
                        <div class="b-time"><i class="icon_clock_alt"></i> 28th April, 2019</div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="blog-item set-bg" data-setbg="../hotel/img/blog/blog-7.jpg">
                    <div class="bi-text">
                        <span class="b-tag">Travel Trip</span>
                        <h4><a href="../guest/guestBlog-Detail.jsp">Bryce Canyon A Stunning</a></h4>
                        <div class="b-time"><i class="icon_clock_alt"></i> 29th April, 2019</div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="blog-item set-bg" data-setbg="../hotel/img/blog/blog-8.jpg">
                    <div class="bi-text">
                        <span class="b-tag">Event & Travel</span>
                        <h4><a href="../guest/guestBlog-Detail.jsp">Motorhome Or Trailer</a></h4>
                        <div class="b-time"><i class="icon_clock_alt"></i> 30th April, 2019</div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="blog-item set-bg" data-setbg="../hotel/img/blog/blog-9.jpg">
                    <div class="bi-text">
                        <span class="b-tag">Camping</span>
                        <h4><a href="../guest/guestBlog-Detail.jsp">Lost In Lagos Portugal</a></h4>
                        <div class="b-time"><i class="icon_clock_alt"></i> 30th April, 2019</div>
                    </div>
                </div>
            </div>
